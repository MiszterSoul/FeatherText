...
Snapshot date: **2026-07-27**. This page compares documented architecture, setup, extension model, and license using project-controlled sources. It does not rank products or infer quality from popularity.
...
- 70 Node/JSDOM unit/regression tests;
- 17 Playwright E2E cases each on Chromium 151, Firefox 153, WebKit 26.5, Mobile Chrome profile, and Tablet WebKit profile (85 executions);
